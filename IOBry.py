...
def createBryFile(grdROMS,outfilename):
     ...
     v_temp_west=f1.createVariable('temp_west', 'f', ('ocean_time', 's_rho', 'eta_rho',),zlib=False)
     ...
     v_temp_west._FillValue = grdROMS.fill_value
     v_temp_west.time = "ocean_time"
     
     v_temp_east=f1.createVariable('temp_east', 'f', ('ocean_time', 's_rho', 'eta_rho',),zlib=False)
     ...
     v_temp_east._FillValue = grdROMS.fill_value
     v_temp_east.time = "ocean_time"
     
     v_temp_south=f1.createVariable('temp_south', 'f', ('ocean_time', 's_rho', 'xi_rho',),zlib=False)
     ...
     v_temp_south._FillValue = grdROMS.fill_value
     v_temp_south.time = "ocean_time"
     
     v_temp_north=f1.createVariable('temp_north', 'f', ('ocean_time', 's_rho', 'xi_rho',),zlib=False)
     ...
     v_temp_north._FillValue = grdROMS.fill_value
     v_temp_north.time = "ocean_time"
     
     v_salt_west=f1.createVariable('salt_west', 'f', ('ocean_time', 's_rho', 'eta_rho',),zlib=False)
     v_salt_west.long_name = "salinity western boundary condition"
     v_salt_west.field = "salt_west, scalar, series"
     v_salt_west._FillValue = grdROMS.fill_value
     v_salt_west.time = "ocean_time"
     
     v_salt_east=f1.createVariable('salt_east', 'f', ('ocean_time', 's_rho', 'eta_rho',),zlib=False)
     v_salt_east.long_name = "salinity eastern boundary condition"
     v_salt_east.field = "salt_east, scalar, series"
     v_salt_east._FillValue = grdROMS.fill_value
     v_salt_east.time = "ocean_time"
     
     v_salt_south=f1.createVariable('salt_south', 'f', ('ocean_time', 's_rho', 'xi_rho',),zlib=False)
     v_salt_south.long_name = "salinity southern boundary condition"
     v_salt_south.field = "salt_south, scalar, series"
     v_salt_south._FillValue = grdROMS.fill_value
     v_salt_south.time = "ocean_time"
     
     v_salt_north=f1.createVariable('salt_north', 'f', ('ocean_time', 's_rho', 'xi_rho',),zlib=False)
     v_salt_north.long_name = "salinity northern boundary condition"
     v_salt_north.field = "salt_north, scalar, series"
     v_salt_north._FillValue = grdROMS.fill_value
     v_salt_north.time = "ocean_time"
     
     v_ssh_west=f1.createVariable('zeta_west','f',('ocean_time','eta_rho',),zlib=False)
     ...
     v_ssh_west._FillValue = grdROMS.fill_value
     v_ssh_west.time = "ocean_time"

     v_ssh_east=f1.createVariable('zeta_east','f',('ocean_time','eta_rho',),zlib=False)
     ...
     v_ssh_east._FillValue = grdROMS.fill_value
     v_ssh_east.time = "ocean_time"
  
     v_ssh_south=f1.createVariable('zeta_south','f',('ocean_time','xi_rho',),zlib=False)
     ...
     v_ssh_south._FillValue = grdROMS.fill_value
     v_ssh_south.time = "ocean_time"

     v_ssh_north=f1.createVariable('zeta_north','f',('ocean_time','xi_rho',),zlib=False)
     ...
     v_ssh_north._FillValue = grdROMS.fill_value
     v_ssh_north.time = "ocean_time"

     v_u_west=f1.createVariable('u_west', 'f', ('ocean_time', 's_rho', 'eta_u',),zlib=False)
     ...
     v_u_west._FillValue = grdROMS.fill_value
     v_u_west.time = "ocean_time"
     
     v_u_east=f1.createVariable('u_east', 'f', ('ocean_time', 's_rho', 'eta_u',),zlib=False)
     ...
     v_u_east._FillValue = grdROMS.fill_value
     v_u_east.time = "ocean_time"
     
     v_u_south=f1.createVariable('u_south', 'f', ('ocean_time', 's_rho', 'xi_u',),zlib=False)
     ...
     v_u_south._FillValue = grdROMS.fill_value
     v_u_south.time = "ocean_time"
     
     v_u_north=f1.createVariable('u_north', 'f', ('ocean_time', 's_rho', 'xi_u',),zlib=False)
     ...
     v_u_north._FillValue = grdROMS.fill_value
     v_u_north.time = "ocean_time"
     
     v_v_west=f1.createVariable('v_west', 'f', ('ocean_time', 's_rho', 'eta_v',),zlib=False)
     ...
     v_v_west._FillValue = grdROMS.fill_value
     v_v_west.time = "ocean_time"
     
     v_v_east=f1.createVariable('v_east', 'f', ('ocean_time', 's_rho', 'eta_v',),zlib=False)
     ...
     v_v_east._FillValue = grdROMS.fill_value
     v_v_east.time = "ocean_time"
     
     v_v_south=f1.createVariable('v_south', 'f', ('ocean_time', 's_rho', 'xi_v',),zlib=False)
     ...
     v_v_south._FillValue = grdROMS.fill_value
     v_v_south.time = "ocean_time"
     
     v_v_north=f1.createVariable('v_north', 'f', ('ocean_time', 's_rho', 'xi_v',),zlib=False)
     ...
     v_v_north._FillValue = grdROMS.fill_value
     v_v_north.time = "ocean_time"
     
     v_vbar_west=f1.createVariable('vbar_west', 'f', ('ocean_time', 'eta_v',),zlib=False)
     ...
     v_vbar_west._FillValue = grdROMS.fill_value
     v_vbar_west.time = "ocean_time"
     
     v_vbar_east=f1.createVariable('vbar_east', 'f', ('ocean_time', 'eta_v',),zlib=False)
     ...
     v_vbar_east._FillValue = grdROMS.fill_value
     v_vbar_east.time = "ocean_time"
     
     v_vbar_south=f1.createVariable('vbar_south', 'f', ('ocean_time', 'xi_v',),zlib=False)
     ...
     v_vbar_south._FillValue = grdROMS.fill_value
     v_vbar_south.time = "ocean_time"
     
     v_vbar_north=f1.createVariable('vbar_north', 'f', ('ocean_time', 'xi_v',),zlib=False)
     ...
     v_vbar_north._FillValue = grdROMS.fill_value
     v_vbar_north.time = "ocean_time"
     
     v_ubar_west=f1.createVariable('ubar_west', 'f', ('ocean_time', 'eta_u',),zlib=False)
     ...
     v_ubar_west._FillValue = grdROMS.fill_value
     v_ubar_west.time = "ocean_time"
     
     v_ubar_east=f1.createVariable('ubar_east', 'f', ('ocean_time', 'eta_u',),zlib=False)
     ...
     v_ubar_east._FillValue = grdROMS.fill_value
     v_ubar_east.time = "ocean_time"
     
     v_ubar_south=f1.createVariable('ubar_south', 'f', ('ocean_time', 'xi_u',),zlib=False)
     ...
     v_ubar_south._FillValue = grdROMS.fill_value
     v_ubar_south.time = "ocean_time"
     
     v_ubar_north=f1.createVariable('ubar_north', 'f', ('ocean_time', 'xi_u',),zlib=False)
     ...
     v_ubar_north._FillValue = grdROMS.fill_value
