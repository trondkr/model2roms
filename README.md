...
<p style="float: left; font-size: 9pt; text-align: center; width: 20%; height: 20% margin-right: 1%; margin-bottom: 0.5em;"><img src="http://www.trondkristiansen.com/wp-content/gallery/romstools/temperature_depth_ESMF_0_withfilter_time_75190.0.png" style="width: 20%">With filter</p>

<p style="float: left; font-size: 9pt; text-align: center; width: 20%; height: 20% margin-right: 1%; margin-bottom: 0.5em;"><img src="http://www.trondkristiansen.com/wp-content/gallery/romstools/temperature_depth_ESMF_0_withoutfilter_time_75190.0.png" style="width: 20%">Without filter</p>
